// verify_h2_17.m -- INDEPENDENT Magma certification of h2(17) = 8
// self-contained certification; the embedded structure constants use q = 3
...
RLO := 1;  RHI := 8;  // STAGE2 class range (chunk if needed)

p := 17;  EXPECTED := 8;
B<i,j,k> := QuaternionAlgebra< Rationals() | -3, -17 >;
e := [
  B![1/2, 1/6, 0, 2/3],
  B![0, 1/3, 0, 1/3],
  B![0, 0, 1/2, 1/2],
...
Amats := [
  Matrix(Integers(), 4,4, [-45, 23, 0, 23, -23, 12, 1, 11, -34, 0, 0, 23, -68, 34, -1, 35]),
  Matrix(Integers(), 4,4, [-23, 12, -1, 12, -12, 6, 0, 6, -17, 0, -1, 12, -34, 17, -2, 18]),
  Matrix(Integers(), 4,4, [-34, 34, 1, 11, -17, 17, 1, 5, -34, 17, 0, 17, -51, 51, 0, 17]),
  Matrix(Integers(), 4,4, [-68, 34, 1, 34, -34, 17, 2, 16, -51, 0, 0, 34, -102, 51, 0, 51])
];
classes := [
  <1, 1, [0,0,0,0], 72>,
  <2, 4, [-2,0,0,1], 24>,

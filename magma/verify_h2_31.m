// verify_h2_31.m -- INDEPENDENT Magma certification of h2(31) = 26
...
RLO := 1;  RHI := 26;  // STAGE2 class range (chunk if needed)

p := 31;  EXPECTED := 26;
B<i,j,k> := QuaternionAlgebra< Rationals() | -1, -31 >;
e := [
  B![1/2, 0, 1/2, 0],
  B![0, 1/2, 0, 1/2],
  B![0, 0, 1, 0],
...
Amats := [
  Matrix(Integers(), 4,4, [-15, 0, 8, 0, 0, 16, 0, -8, -31, 0, 16, 0, 0, 31, 0, -15]),
  Matrix(Integers(), 4,4, [0, -15, 0, 8, -16, 0, 8, 0, 0, -31, 0, 16, -31, 0, 15, 0]),
  Matrix(Integers(), 4,4, [-31, 0, 16, 0, 0, 31, 0, -16, -62, 0, 31, 0, 0, 62, 0, -31]),
  Matrix(Integers(), 4,4, [0, -31, 0, 16, -31, 0, 16, 0, 0, -62, 0, 31, -62, 0, 31, 0])
];
classes := [
  <1, 1, [0,0,0,0], 32>,
  <2, 5, [-2,-1,1,0], 8>,

// verify_h2_37.m -- INDEPENDENT Magma certification of h2(37) = 37
...
RLO := 1;  RHI := 37;  // STAGE2 class range (chunk if needed)

p := 37;  EXPECTED := 37;
B<i,j,k> := QuaternionAlgebra< Rationals() | -2, -37 >;
e := [
  B![1/2, 0, 1/2, 1/2],
  B![0, 1/4, 1/2, 1/4],
  B![0, 0, 1, 0],
...
Amats := [
  Matrix(Integers(), 4,4, [-55, 0, 28, 28, -37, -18, 28, 23, -37, -74, 56, 37, -74, 74, 0, 19]),
  Matrix(Integers(), 4,4, [-37, 19, 9, 14, -28, 0, 14, 14, -37, -37, 37, 28, -37, 74, -19, 0]),
  Matrix(Integers(), 4,4, [-37, 74, -18, 0, -37, 37, 0, 9, -74, 0, 37, 37, 0, 148, -74, -37]),
  Matrix(Integers(), 4,4, [-74, -74, 74, 56, -37, -74, 56, 37, 0, -148, 74, 37, -148, 0, 74, 74])
];
classes := [
  <1, 1, [0,0,0,0], 8>,
  <2, 10, [0,-2,1,0], 48>,
